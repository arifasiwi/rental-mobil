...
app.controller('CarsCtrl', ['$scope', 'cars', 'SweetAlert', '$http','$timeout', function ($scope, cars,SweetAlert) {
//urussan tampilan
    $scope.main = {
        page: 1,
        term: ''
    ...
    $scope.dataCars = '';
    // init get data
    cars.get($scope.main.page, $scope.main.term)

app.controller('CarsCreateCtrl', ['$state', '$scope', 'cars','$timeout', 'SweetAlert','toaster','$http', function ($state, $scope, cars,$timeout, SweetAlert,toaster) {

app.controller('DriversEditCtrl', ['$state', '$scope', 'drivers','$timeout', 'SweetAlert','toaster', '$stateParams', '$http', function ($state, $scope, drivers,$timeout, SweetAlert,toaster,$stateParams) {

app.controller('DriversCreateCtrl', ['$state', '$scope', 'drivers','$timeout', 'SweetAlert','toaster','$http', function ($state, $scope, drivers,$timeout, SweetAlert,toaster) {

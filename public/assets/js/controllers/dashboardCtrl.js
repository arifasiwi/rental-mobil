...
$scope.refreshdata = function () {
    transactions.cekpnguunjung(1)
        .success(function (data) {
            $scope.jan = data;
            transactions.cekpnguunjung(2)
                .success(function (data) {
                    $scope.feb = data;
                    transactions.cekpnguunjung(3)
                        .success(function (data) {
                            $scope.mar = data;
                            transactions.cekpnguunjung(4)
                                .success(function (data) {
                                    $scope.apr = data;
                                    transactions.cekpnguunjung(5)
                                        .success(function (data) {
                                            $scope.mei = data;
                                            transactions.cekpnguunjung(6)
                                                .success(function (data) {
                                                    $scope.jun = data;
                                                    transactions.cekpnguunjung(7)
                                                        .success(function (data) {
                                                            $scope.juli = data;
                                                            transactions.cekpnguunjung(8)
                                                                .success(function (data) {
                                                                    $scope.agus = data;
                                                                    transactions.cekpnguunjung(9)
                                                                        .success(function (data) {
                                                                            $scope.sep = data;
                                                                            transactions.cekpnguunjung(10)
                                                                                .success(function (data) {
                                                                                    $scope.okto = data;
                                                                                    transactions.cekpnguunjung(11)
                                                                                        .success(function (data) {
                                                                                            $scope.nov = data;
                                                                                            transactions.cekpnguunjung(12)
                                                                                                .success(function (data) {
                                                                                                    $scope.des = data;
